  ...
  return (
    <div className="section" id="about">
      ...
      <div className="content-block">
        <h2>What do we do?</h2>
        <p><em>*This is placeholder Text. I am editing this to include what you sent me the other day*</em></p>
        <br />
        <p>Thank you for visiting, and welcome to Panzy No Shoes, where luxury meets self-care! Founded by the Angie York, our brand is all about spreading happiness through aromatherapy experiences. With a commitment to promoting self-care, our products are crafted with love and precision, ensuring a blissful escape from the ordinary.</p>
        <br/>
